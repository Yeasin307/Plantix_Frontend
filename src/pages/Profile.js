                ...
                >
                    ...
                    >
                        ...
                        <DialogContent>
                            ...
                            <h6 style={{ textDecoration: 'underline', color: '#002884' }}>User Name</h6>
                            <p>{userInfo?.username}</p>

                            <h6 style={{ textDecoration: 'underline', color: '#002884' }}>EMAIL</h6>
                            <p>{userInfo?.email}</p>

                            <h6 style={{ textDecoration: 'underline', color: '#002884' }}>FIRST NAME</h6>
                            <p>{userInfo?.firstName}</p>

                            <h6 style={{ textDecoration: 'underline', color: '#002884' }}>LAST NAME</h6>
